(function() {
  ...
  DiffView.prototype = {
    ...
    init: function(pane, orig, options) {
      ...
      this.forceUpdate = function(){this.diffOutOfDate = true; registerUpdate(this);};
  ...
  var MergeView = CodeMirror.MergeView = function(node, options) {
    ...
    var editPane;
    if (options.edit){
        editPane = options.edit;
    } else {
        editPane = elt("div", null, "CodeMirror-merge-pane");        
    }
  ...
  function getDiff(text1, text2) {
    ...
    //jQuery('#merge-preview').html(dmp.diff_prettyHtml(diff));
    return diff;
  }
