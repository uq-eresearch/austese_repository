...
<div class="row-fluid">
    <div class="well well-large span6">
        ...
        <ul>
            <li><a href="/repository/artefacts/edit">Describe new artefact</a></li>
            <li><a href="/repository/versions/edit">Describe new version</a></li>
            <li><a href="/repository/works/edit">Describe new work</a></li>
            <li><a href="/repository/agents/edit">Describe new agent</a></li>
            <li><a href="/repository/events/edit">Describe new event</a></li>
        </ul>
    </div>
    <div class="well well-large span6">
        <h3>Upload Digitised Resources</h3>
        <p>Before or after bibliographical description has been commenced, images and transcriptions can be uploaded and described using the <a href="/repository/resources">Digital Resource Organiser</a>. Descriptions can be added to individual files or batches of files.</p> 
...
<div class="row-fluid">
    <div class="span6 well well-large">
        <h3>Link</h3>
        <p>After bibliographical descriptions are added and digital resources are uploaded, images and transcriptions can be linked to their respective entities, such as an artefact or version. Edit <a href="/repository/artefacts">artefact</a> and <a href="/repository/versions">version</a> metadata to link to transcriptions or facsimiles.</p>
    </div>

    <div class="span6 well well-large">
        <h3>Align</h3>
        <p>To support efficient navigation between images and associated transcriptions, alignment is necessary. Align sections of transcriptions and facsimiles with the <a href="/alignment/edit">Alignment Tool</a>.</p>
    </div>
</div>
<div class="row-fluid">
    <div class="span12 well well-large">
        ...
        <p>Compare images using the <a href="/lightbox">Light Box</a>.</p>
        <p>To compare textual variation, create an MVD from selected transcription resources via the Send To menu in the <a href="/repository/resources">Digital Resource Organiser</a>.</p>
        <p>View existing MVDs as a <a href="/collationtools/compare">side-by-side</a> view or <a href="/collationtools/apparatus">table apparatus</a> <!--via the same menu or from individual resource metadata record pages.--></p>
    </div>
</div>
<div class="row-fluid">
    <div class="span12 well well-large">
